...
export function FloatingCallCta() {
  ...
  return (
    <a
      ...
      title="Call WAVE"
      className={`group fixed bottom-5 right-5 z-50 grid h-16 w-16 place-items-center rounded-full border border-white/70 bg-[#F58220] text-white shadow-[0_18px_42px_rgba(6,42,96,0.28)] transition-[opacity,transform,box-shadow] duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-1 hover:shadow-[0_24px_52px_rgba(6,42,96,0.34)] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#0077C8]/30 sm:bottom-7 sm:right-7 ${
